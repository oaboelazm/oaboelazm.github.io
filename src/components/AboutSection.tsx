...
const AboutSection = () => {
  return (
    <section id="about" className="py-40 lg:py-52 relative">
      <div className="section-divider absolute top-0 left-0 right-0" />

      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        <HeroReveal className="mb-20">
          <p className="text-primary font-mono font-medium tracking-[0.25em] uppercase text-[11px] mb-4">About</p>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          <Parallax speed={0.15}>
            <div className="space-y-8 text-lg lg:text-xl text-muted-foreground">
            ...
            {interests.map((item) => {
              ...
              return (
                <StaggerItem key={item.label}>
                  <div className="cosmic-card p-7 hover:border-primary/20 transition-all duration-500 group cursor-default h-full hover:translate-y-[-4px] hover:shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.15)]">
                    <div className="w-11 h-11 rounded-xl bg-primary/8 flex items-center justify-center mb-5 group-hover:bg-primary/12 group-hover:scale-110 transition-all duration-500">
